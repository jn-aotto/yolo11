...
parser.add_argument('--model', type=str, default=ROOT / 'model/yolo11m-seg.pt', help='initial weights path')
parser.add_argument('--cfg', type=str, default=ROOT / 'shiliyu/yolo11m-seg.yaml', help='model.yaml path')
parser.add_argument('--data', type=str, default=ROOT / 'shiliyu/zijide_renyuanjiance_seg.yaml', help='dataset.yaml path')
...
parser.add_argument('--project', default=r'D:\renyuan_seg_640_p5_10.09', help='save to project/name')
...
parser.add_argument('--freeze', nargs='+', type=int, default=[0,1,2,3,4,5,6], help='Freeze layers: backbone=10, first3=0 1 2')
...
#-------------
    #model = YOLO(r"D:\MODEL\MODEL_sly\renyuan_640_p5_3.9\train\exp\weights\last.pt") # 直接加载模型
