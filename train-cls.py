...
parser.add_argument('--task', type=str, default='classify', help='task type')

parser.add_argument('--model', type=str, default=ROOT / 'model/yolo11x-cls.pt', help='initial weights path')
parser.add_argument('--cfg', type=str, default=ROOT / 'shiliyu/yolo11x-cls.yaml', help='model.yaml path')
parser.add_argument('--data', type=str, default=ROOT / './cutting-inspection-origin', help='dataset.yaml path')
...
parser.add_argument('--project', default=r'C:\Users\sly\Desktop\liaopian', help='save to project/name')
