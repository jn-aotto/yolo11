...
parser.add_argument('--format', type=str, default='engine', help='export model')

parser.add_argument('--model', nargs='+', type=str, default=r'D:\yolo11\model\bestyolo11.pt', help='model path(s)')
#parser.add_argument('--onnxmodel', nargs='+', type=str, default=r'C:\Users\sly\Desktop\xiaozi\exp3\weights\best.onnx', help='model path(s)')
...
parser.add_argument('--opset', type=str, default=14, help='onnx banben')
