...
parser.add_argument('--model', nargs='+', type=str, default=r"D:\yolo11\kailiehuahen\best.onnx", help='model path(s)')

parser.add_argument('--source', type=str, default=r'C:\Users\sly\Desktop\2025-03-19\humandetect', help='file/dir/URL/glob/screen/0(webcam)')

parser.add_argument('--imgsz', type=int, default=1280, help='size of each image dimension')
